 ...
 */
public class CSelectorModule_bu extends BaseInitAble implements IGuiModule
{
    public static final String MODULENAME = "CSELECTMODULE";

    public static final String MENU_CAPTION_ON = Enc.get("$84");
    public static final String MENU_CAPTION_OFF = Enc.get("$85");

    public static final String HINT_CAPTION_ON = MENU_CAPTION_ON;
    public static final String HINT_CAPTION_OFF = MENU_CAPTION_OFF;
...
//    private BufferedImage raster;
    ...
    public CSelectorModule_bu()
	{
	}

	public CSelectorModule_bu(IViewControl mainmodule)
	{
...
//    }
	...
	public void registerListeners(JComponent component) throws Exception
	{
        ...
        component.addMouseMotionListener(new MouseMotionListener()
        {
            ...
            {
                try {
                    if (!e.isConsumed() && mode==SELECT_BY_MOUSE && pr!=null && pt!=null)
                    {
                        ...
                        try
                        {
                            ...
                            {
                                BufferedImage raster = pr.getImageByRectangle(new Rectangle((int) rPnt.getX(), (int) rPnt.getY(),
