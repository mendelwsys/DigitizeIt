 ...
 */
public class TPartialImageReaderT3 extends Panel {

    private BufferedImage images[][];


  public TPartialImageReaderT3() throws Exception
  {

    String filename = "C:\\PapaWK\\Projects\\JavaProj\\VICTOR\\DigitizeItRes\\MAPDIR\\MAPS.png";
    String extensionName = filename.substring(filename.lastIndexOf('.') + 1);
    InputStream inputStream = new BufferedInputStream(new FileInputStream(filename));

//    ByteOutputStream bos = new ByteOutputStream(5*1024*1024);
//
//      byte[] b = new byte[1024 * 1024];
//      int ln;
//      while((ln=inputStream.read(b))>0)
//          bos.write(b,0,ln);
//
//      inputStream.close();
//      bos.close();
//
//      inputStream=new ByteArrayInputStream(bos.getBytes());
...
//          }
  ...
  static public void main(String args[]) throws Exception {
    ...
    Panel panel = new TPartialImageReaderT3();
    frame.add(panel);
